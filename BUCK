...
rust_library(
    ...
    deps = [
        ...
        "//third-party/rust/crates/js-sys/0.3.81:js-sys",
        ...
        "//third-party/rust/crates/wasm-bindgen/0.2.104:wasm-bindgen",
        "//third-party/rust/crates/web-sys/0.3.81:web-sys",
        "//third-party/rust/crates/zerocopy-derive/0.8.27:zerocopy-derive",
        "//third-party/rust/crates/zerocopy/0.8.27:zerocopy",
